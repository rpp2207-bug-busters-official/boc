      ...
      >
        ...
        <Modal.Body>
          <form>
            ...
            width='75'
            height='100'
            style={{height: "max(5vh,min(5vw,90px))", width: "auto", marginBottom:'15px'}}
            ...
            <div className="row mb-4">
              ...
              <div className="col">
                <Link href="/resetPasswordPage" style={{color:'#FF5533'}} onClick={() => {setModalShow(false)}}>Forgot password?</Link>
              </div>
            </div>
            ...
            <button type="button" className="btn btn-success" id='a-btn-lnk' onClick={() => {handleLoginClick(LoginUser)}}>Sign in</button>

            <div className="text-center">
              <p>or sign in with:</p>
              <Button onClick={() => {googleLogin(props1.updateCookie)}} variant='success' id='a-btn-lnk'>
              ...
              &nbsp;
              <Button onClick={() => {facebookLogin(props1.updateCookie)}} variant='success' id='a-btn-lnk'>
